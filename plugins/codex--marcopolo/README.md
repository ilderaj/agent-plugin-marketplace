# Marcopolo (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--marcopolo
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/marcopolo
- Version: 1.0.0
