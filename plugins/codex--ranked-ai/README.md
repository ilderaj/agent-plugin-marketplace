# Ranked Ai (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--ranked-ai
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/ranked-ai
- Version: 1.0.0
