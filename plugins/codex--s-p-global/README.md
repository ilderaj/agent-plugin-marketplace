# S P Global (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--s-p-global
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/s-p-global
- Version: 2.0.0
