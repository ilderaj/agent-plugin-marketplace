# Keybid Puls (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--keybid-puls
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/keybid-puls
- Version: 1.0.0
