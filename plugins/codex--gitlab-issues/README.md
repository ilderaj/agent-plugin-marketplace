# Gitlab Issues (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--gitlab-issues
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/gitlab-issues
- Version: 1.0.0
