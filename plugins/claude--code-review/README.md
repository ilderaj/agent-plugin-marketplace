...
- Plugin ID: claude-code--code-review
...
- Source Path: /Users/jared/AgentPlugins/agent-plugin-marketplace/.worktrees/copilot-compat/.cache/sync/claude-code/plugins/code-review
- Version: 1.0.0
