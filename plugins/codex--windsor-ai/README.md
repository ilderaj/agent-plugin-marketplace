# Windsor Ai (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--windsor-ai
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/windsor-ai
- Version: 1.0.0
