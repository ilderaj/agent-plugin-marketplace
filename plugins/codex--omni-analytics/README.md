# Omni Analytics (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--omni-analytics
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/omni-analytics
- Version: 1.0.0
