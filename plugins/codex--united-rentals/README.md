# United Rentals (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--united-rentals
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/united-rentals
- Version: 1.0.0
