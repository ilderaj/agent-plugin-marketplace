# Biorender (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--biorender
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/biorender
- Version: 1.0.0
