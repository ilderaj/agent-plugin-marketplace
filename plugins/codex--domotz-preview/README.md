# Domotz Preview (from Codex)

## Source
- Platform: codex
- Plugin ID: codex--domotz-preview
- Upstream: https://github.com/openai/plugins.git
- Source Path: /home/runner/work/agent-plugin-marketplace/agent-plugin-marketplace/.cache/sync/codex/plugins/domotz-preview
- Version: 1.0.0
